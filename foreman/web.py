...
def _render_header(config: Config, db: CoordinationDB | None) -> str:
    ...
    return (
        ...
        f'<select name="mode" id="innovate-mode" hx-preserve="true"><option value="innovate">Innovate</option>'
        f'<option value="cleanup">Cleanup</option><option value="test">Test</option></select>'
        f'<select name="model" id="innovate-model" hx-preserve="true"><option value="">default</option>'
